...
# Usage: python vsan6.py --host 10.160.83.91 --user 'administrator@vsphere.local' --password 'Admin!23'
...
def main():
   ...
   if aboutInfo.apiType == 'VirtualCenter':
      ...
      vhs = vcMos['vsan-capability-system']
      ...
      for hostStatus in clusterStatus.trackedHostsStatus:
        ...
        health = vhs.VsanCapabilitySystem.statuses(
            cluster=cluster)
        clusterStatus = capability
