...
# Usage: python vsanapi_vc_healthinterval.py --host 10.160.83.91 --user 'administrator@vsphere.local' --password 'Admin!23'
...
# and client side cert verification
    ...
    if aboutInfo.apiType == 'VirtualCenter':
        ...
        healthinterval = vhs.VsanHealthQueryVsanClusterHealthCheckInterval(
            cluster=cluster)
        clusterStatus = healthinterval

        print("vSAN Health Check Interval is: %i" %
