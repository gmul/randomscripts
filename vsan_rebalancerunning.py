#!/usr/bin/env python
# -*- coding: utf-8 -*-
# python vsan_rebalancerunning.py --host 10.160.83.91 --user 'administrator@vsphere.local' --password 'Admin!23'
...
vcMos = vsanapiutils.GetVsanVcMos(si._stub, context=None)
...
rebalancestatus = vhs.VsanHealthIsRebalanceRunning(
            cluster=cluster)
clusterStatus = rebalancestatus

print("Cluster %s Is Rebalancing: %s" %
